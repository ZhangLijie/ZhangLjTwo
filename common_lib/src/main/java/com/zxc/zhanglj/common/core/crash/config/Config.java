...
package com.zxc.zhanglj.common.core.crash.config;

import android.annotation.SuppressLint;
import android.os.Environment;

import com.zxc.zhanglj.common.core.crash.utils.ContextProvider;
import com.zxc.zhanglj.common.core.crash.utils.CrashFileUtil;
import com.zxc.zhanglj.common.core.crash.utils.CrashUtil;
...
public final class Config {
    ...
    public static void init(String appName) {
        if (CrashUtil.isStringEmpty(appName)) {
            return;
        }
        sAppName = appName;
    ...
    private static void initAllDir() {
        ...
        // this directory.
        CrashFileUtil.createFile(Config.getNoMediaFilePath());
        ...
        for (String dirPath : allDir) {
            CrashFileUtil.createDir(dirPath);
        }

        CrashFileUtil.createFile(Config.getDownloadNoMediaFilePath());
    }
