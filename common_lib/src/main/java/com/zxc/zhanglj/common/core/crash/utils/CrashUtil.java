...
//    private static final Logger sLogger = new Logger("Utils");
    ...
    public static void addShortcut(Context context, Class<?> startClass,
        ...
        if (CrashUtil.hasShortCut(context, shortCutName)) {
            if (!coverOld) {
                return;
            } else {
    ...
    public static Bitmap decodeBitmap(String pathName) {
        ...
        try {
            ...
            Log.e(TAG, "Could not load large image" + e.getMessage());
        }
    ...
    public static String getVersionName(Context context) {
        ...
        try {
            ...
            Log.e(TAG, "get app version name error! " + e.getMessage());
            e.printStackTrace();
        }
        return versionName;
    }
...
//    }
    ...
    public static String[] getRandomStringArray(String[] array) {
        ...
        if (CrashUtil.isArrayEmpty(array)) {
            return null;
        }
    ...
    public static String parseBaseUrl(String domain, String fullUrl) {
        ...
        if (!CrashStringUtil.equalsNull(fullUrl) && !CrashStringUtil.equalsNull(domain)) {
