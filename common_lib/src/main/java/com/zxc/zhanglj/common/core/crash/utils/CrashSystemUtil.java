...
public class CrashSystemUtil {
    ...
    public static String getMacAddress() {// get mac from share
        ...
        if (CrashStringUtil.equalsNull(result)) {
        ...
        if (CrashStringUtil.equalsNull(result)) {
            ...
            if (TextUtils.isEmpty(result)) {
                ...
                if (!CrashStringUtil.equalsNull(result) && result.length() > 0) {
        ...
        if (CrashStringUtil.isBlank(result)) {
            sMac = "";
            return sMac;
    ...
    private static String newGetMacAddress() {
        ...
        if (CrashStringUtil.isBlank(Mac)) {
            return null;
        }
        if (Mac.length() > 1) {
        ...
        return CrashStringUtil.stringChangeCapital(result);
    }
    ...
    public static int getPidByProcessName(Context context, String name) {
        if (CrashStringUtil.isBlank(name)) {
            return -1;
        }
