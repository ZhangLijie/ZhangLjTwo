package com.zxc.zhanglj.zhangljfirst.manager;
...
public class EventBusManager
{
    ...
    /** {@value} */
    public static final int DEFAULT_THREAD_POOL_SIZE = Runtime.getRuntime().availableProcessors() * 2 >= 5 ? 5 : Runtime.getRuntime().availableProcessors() * 2;
    /** {@value} */
